...
const {familyGitEnvironment}=require('./family-read-auth');
const registry=require('../family-registry.json');
const {CONSUMERS}=require('./resolve-family-snapshot');
const OWNER=registry.owner;
function git(args,cwd){return execFileSync('git',args,{cwd,env:familyGitEnvironment(),stdio:['ignore','pipe','inherit'],encoding:'utf8'}).trim();}
