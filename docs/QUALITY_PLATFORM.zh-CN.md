...
Codex Safe Core 4.18.2 / Quality Platform v3 修复 UTF-8 流边界与成功终态判定，并保留 Finding Claim Contract v1、Model Routing Contract v1、change-aware Evidence Risk 与唯一 canonical `CI Gate`。Safe Contract v2、Policy Schema v4、Runtime v3 与 Provider Contract v3 继续作为安全边界。
