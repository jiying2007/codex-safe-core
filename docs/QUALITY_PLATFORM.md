...
Codex Safe Core 4.18.2 / Quality Platform v3 repairs UTF-8 streaming and successful-terminal validation while retaining Finding Claim Contract v1, Model Routing Contract v1, change-aware Evidence Risk and the canonical `CI Gate`. Safe Contract v2, Policy Schema v4, Runtime v3 and Provider Contract v3 remain the safety boundary.
